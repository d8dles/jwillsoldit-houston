---
title: "Houston renter checklist: what to verify before move-in"
seoTitle: "Houston Renter Checklist | JWILLSOLDIT"
slug: "houston-renter-checklist"
description: "A Houston apartment and rental checklist for applications, leases, utilities, maintenance, insurance, security, and move-in records."
disclaimerIds:
  - general
sources:
  - label: "Texas Legislature — Property Code Chapter 92, Residential Tenancies"
    url: "https://statutes.capitol.texas.gov/Docs/PR/htm/PR.92.htm"
    accessed: "2026-08-11"
  - label: "Texas Department of Insurance — Renters insurance"
    url: "https://www.tdi.texas.gov/tips/renters-insurance.html"
    accessed: "2026-08-11"
  - label: "Public Utility Commission of Texas — Power to Choose"
    url: "https://www.powertochoose.org/"
    accessed: "2026-08-11"
  - label: "City of Houston — 311 and water customer service"
    url: "https://www.houstontx.gov/ara/311.html"
    accessed: "2026-08-11"
  - label: "HUD — Housing discrimination under the Fair Housing Act"
...
Electric service also depends on the exact address. Many Houston-area customers can choose a retail electric provider, while some addresses are served under a different utility structure. Verify the service territory first, then compare plan term, price components, cancellation terms, deposit rules, and usage assumptions through the official Power to Choose marketplace when it applies. Ask the property who handles water, gas, trash, and recycling. Do not assume a City of Houston mailing address means every service comes from the city. The [Houston electricity and utilities guide](/houston/guides/electricity-choice-and-utilities) explains why providers and billing structures change by address.
...
## Decide on renters insurance before move-in
